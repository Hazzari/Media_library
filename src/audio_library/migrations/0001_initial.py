    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(blank=True, null=True, upload_to=src.base.services.get_path_upload_cover_album, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg']), src.base.services.validate_size_img])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_of_likes', models.ManyToManyField(related_name='likes_tracks', to='oauth.AuthUser')),
            ],
        ),
        migrations.CreateModel(
            name='PlayList',
            fields=[
                ...
                ('cover', models.ImageField(blank=True, null=True, upload_to=src.base.services.get_path_upload_cover_playlist, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg']), src.base.services.validate_size_img])),
                ('track', models.ManyToManyField(related_name='track_play_list', to='audio_library.Track')),
